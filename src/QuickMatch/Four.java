...
//    This is the second player arraylist, its primary function
//    is to just hold the cards of the second player
    ArrayList<String> sPlay = new ArrayList<>(6);

//    This is the third player arraylist, its primary function
//    is to just hold the cards of the third player
    ArrayList<String> tPlay = new ArrayList<>(6);
    
//    This is the fourth player arraylist, its primary function
//    is to just hold the cards of the third player
    ArrayList<String> lPlay = new ArrayList<>(6);
...
//    ***** A Constructor *****
    ...
    private void gamePlay() {
        ...
        /*
        This is where the cards are been distributed randomly to the players.
        Each card randomly taken from the pile and added to the players is been
        removed from the pile... making exit only in the players hand
        ...
        */
        ...
        for (int i = 0; i < 5; i++) {
            int rand = rm.nextInt(al.size());
            tPlay.add(al.get(rand));
            al.remove(rand);
        }
        
        for (int i = 0; i < 5; i++) {
            int rand = rm.nextInt(al.size());
            lPlay.add(al.get(rand));
            al.remove(rand);
        }

//        After cards is been distributed, the game starts... and the First
//        Player is the one to go first
...
//    Random from the java.util is been initialised
    Random rm = new Random();
    
    /*
    These arraylist are specificly created to temporarily hold the
    card been discarded before been thrown to the pile or another 
    player
    */
    ArrayList<String> holdCard = new ArrayList<>(1);
    ArrayList<String> holdCard2 = new ArrayList<>(1);
    ArrayList<String> holdCard3 = new ArrayList<>(1);
    ArrayList<String> holdCard4 = new ArrayList<>(1);
...
//        Displaying the cards of the second player
        for (int i = 0; i < 5; i++) {
            System.out.println(i + ". " + tPlay.get(i));
        }
        ...
        if (take.equals("1")) {
            if (!holdCard.isEmpty()) {
                ...
                tPlay.add(holdCard.get(0));
                System.out.println("Card picked is: " + holdCard.get(0));
                holdCard.remove(0);

                for (int i = 0; i < tPlay.size(); i++) {
                    System.out.println(i + ". " + tPlay.get(i));
                }
                ...
                while (pass == false) {
                    ...
                    switch (ncard) {
                        case 0:
                            pass = true;
                            holdCard3.add(tPlay.get(0));
                            tPlay.remove(0);
                            break;

                        case 1:
                            pass = true;
                            holdCard3.add(tPlay.get(1));
                            tPlay.remove(1);
                            break;

                        case 2:
                            pass = true;
                            holdCard3.add(tPlay.get(2));
                            tPlay.remove(2);
                            break;

                        case 3:
                            pass = true;
                            holdCard3.add(tPlay.get(3));
                            tPlay.remove(3);
                            break;

                        case 4:
                            pass = true;
                            holdCard3.add(tPlay.get(4));
                            tPlay.remove(4);
                            break;

                        case 5:
                            pass = true;
                            holdCard3.add(tPlay.get(5));
                            tPlay.remove(5);
                            break;
                ...
                System.out.println("\nCard discarded is the " + holdCard3.get(0));
                holdCard3.remove(0);

                if (tPlay.get(0) == tPlay.get(1) && tPlay.get(0) == tPlay.get(2)
                        && tPlay.get(0) == tPlay.get(3)
                        && tPlay.get(0) == tPlay.get(4)) {
        ...
        } else if (take.equalsIgnoreCase("D")) {
            ...
            try {
                ...
                System.out.println("\nCard withdrawn is the " + holdCard3.get(0));
                holdCard3.remove(0);
                if (tPlay.get(0) == tPlay.get(1) && tPlay.get(0) == tPlay.get(2)
                        && tPlay.get(0) == tPlay.get(3)
                        && tPlay.get(0) == tPlay.get(4)) {
...
//                
    ...
    void fourth() {
        ...
        System.out.println(Player4 + " Card\n");

//        Displaying the cards of the second player
        for (int i = 0; i < 5; i++) {
            System.out.println(i + ". " + lPlay.get(i));
        }
        ...
        if (take.equals("1")) {
            if (!holdCard.isEmpty()) {
                ...
                while (pass == false) {
                    ...
                    switch (ncard) {
                        case 0:
                            pass = true;
                            holdCard4.add(lPlay.get(0));
                            lPlay.remove(0);
                            break;

                        case 1:
                            pass = true;
                            holdCard4.add(lPlay.get(1));
                            lPlay.remove(1);
                            break;

                        case 2:
                            pass = true;
                            holdCard4.add(lPlay.get(2));
                            lPlay.remove(2);
                            break;

                        case 3:
                            pass = true;
                            holdCard4.add(lPlay.get(3));
                            lPlay.remove(3);
                            break;

                        case 4:
                            pass = true;
                            holdCard4.add(lPlay.get(4));
                            lPlay.remove(4);
                            break;

                        case 5:
                            pass = true;
                            holdCard4.add(lPlay.get(5));
                            lPlay.remove(5);
                            break;
                ...
                System.out.println("\nCard discarded is the " + holdCard4.get(0));
                holdCard4.remove(0);

                if (lPlay.get(0) == lPlay.get(1) && lPlay.get(0) == lPlay.get(2)
                        && lPlay.get(0) == lPlay.get(3)
                        && lPlay.get(0) == lPlay.get(4)) {
            ...
            try {
                ...
                System.out.println("\nCard withdrawn is the " + holdCard4.get(0));
                holdCard4.remove(0);
                if (lPlay.get(0) == lPlay.get(1) && lPlay.get(0) == lPlay.get(2)
                        && lPlay.get(0) == lPlay.get(3)
                        && lPlay.get(0) == lPlay.get(4)) {
...
//                
    ...
    public void save() {
        ...
        try (FileWriter f = new FileWriter("Play4winner.txt", true)) {
            String[] names = {
                winner
            };
